...
from transformers.modeling_bert import BertLayerNorm, BertPreTrainedModel, gelu

COLUMN_SQL_LABEL_COUNT = 563
SQL_DIFF_LABEL_COUNT = 120

class RobertaForContext(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.lm_head = RobertaContextHead(config)
    ...
    def forward(
        ...
        if masked_context_labels is not None:
            ...
            masked_context_loss = context_loss_fct(context_prediction_scores.view(-1, SQL_DIFF_LABEL_COUNT), masked_context_labels.view(-1))
