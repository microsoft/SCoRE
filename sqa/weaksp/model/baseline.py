...
from .util import construct_row_selections, construct_junction, construct_same

from allennlp.semparse.domain_languages import ParsingError, ExecutionError
from allennlp.data.tokenizers.token import Token

from .utils_roberta import get_bert, get_bert_encoding

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name

DATA_DIR_RAW = Path("data/SQA/raw_input")
...
class Programmer(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_roberta:
            ...
            self.CANDIDATE_ACTION_NUM_BOUND = 256
